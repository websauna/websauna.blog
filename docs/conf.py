...
project = 'Websauna\'s Blog Addon'
copyright = '2018, Maksym Shalenyi'
...
htmlhelp_basename = 'WebsaunasBlogAddondoc'
...
latex_documents = [
    (master_doc, 'WebsaunasBlogAddon.tex', 'Websauna\'s Blog Addon Documentation',
     'Maksym Shalenyi', 'manual'),
]
...
man_pages = [
    (master_doc, 'websaunasblogaddon', 'Websauna\'s Blog Addon Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'WebsaunasBlogAddon', 'Websauna\'s Blog Addon Documentation',
     author, 'WebsaunasBlogAddon', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'websauna': ("https://websauna.org/docs/", None),
}
...
plantuml = 'java -jar {}/plantuml.1.2018.6.jar'.format(_here)
